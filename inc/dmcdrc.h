...
#ifndef INCLUDE_DMCDRC
   #define INCLUDE_DMCDRC
...
/* DMA Record Size (General + 1 Axis) */
#define REV01      44
#define REV02      58
#define REV03      66
#define REV04      68
#define REV07      114 //DMC-18x6.  Rev number is the same as Windows
...
enum DMCDataRecordItemIds
{
   ...
   DRIdErrorCode,
   DRIdGeneralStatus,
   DRIdThreadStatus, //18x6 replaces general status.
   DRIdBufferSpaceContour, //18x6
   DRIdSegmentCountContour, //18x6
   
   DRIdSegmentCountS,
   DRIdCoordinatedMoveStatusS,
   DRIdCoordinatedMoveDistanceS,
   DRIdBufferSpaceS, //18x6
   
   DRIdSegmentCountT,
   DRIdCoordinatedMoveStatusT,
   DRIdCoordinatedMoveDistanceT,
   DRIdBufferSpaceT, //18x6
...
/* Data record offsets
   ...
   Rev 5 constants
      ...
      This is the DMC-18x6 data record
      */
...
enum REV7DMCDataRecordGeneralOffsets
{
   ...
   DRREV7GenOffAnalogOut0 = 22, //reserved, new for DMC-18x6
   ...
   DRREV7GenOffEthernetReserved = 38, //reserved, new for DMC-18x6

   DRREV7GenOffErrorCode = 46,
   DRREV7GenOffThreadStatus = 47, //used to be DRREV4GenOffGeneralStatus

   DRREV7GenOffAmpStatus = 48, //reserved, new for DMC-18x6

   DRREV7GenOffSegmentCountContour = 52, //new for DMC-18x6
   DRREV7GenOffBufferSpaceContour = 56,  //new for DMC-18x6

   DRREV7GenOffSegmentCountS = 58,
   DRREV7GenOffCoordinatedMoveStatusS = 60,
   DRREV7GenOffCoordinatedMoveDistanceS = 62,
   DRREV7GenOffBufferSpaceS = 66, //new for DMC-18x6

   DRREV7GenOffSegmentCountT = 68,
   DRREV7GenOffCoordinatedMoveStatusT = 70,
   DRREV7GenOffCoordinatedMoveDistanceT = 72,
   DRREV7GenOffBufferSpaceT = 76, //new for DMC-18x6
   ...
   DRREV7GenOffEnd = 366 //total size of data record in bytes
};
...
enum REV7DMCDataRecordAxisOffsets
{
   ...
   DRREV7AxisOffAxisTorque = 24, //DMC-18x6 new size (used be 2 bytes, now 4 bytes)
   DRREV7AxisOffAnalogInput = 28,
   DRREV7AxisOffReserved = 30,
   DRREV7AxisOffUserVar = 32,
   DRREV7AxisOffEnd = 36 //total bytes per axis section
};
